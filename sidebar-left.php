	...
	<aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                            ...
                            <li>
                                <a href="../blotter/blotter.php">
                                    <i class="fa fa-users"></i> <span>Blotter Report</span>
                                </a>
                            </li>
                            <li>
                                <a href="../clearance/clearance.php">
                                    <i class="fa fa-file"></i> <span>Brgy. Documents </span>
                                </a>
                            </li>
                            <li>
                                <a href="../officials/officials.php">
                                    <i class="fa fa-user"></i> <span> Officials & Staff</span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="../report/report.php">
                                    <i class="fa fa-file"></i> <span>Statistics</span>
                                </a>
                            </li>
                            <li>
                    ...
                    elseif(isset($_SESSION['staff'])){
                        ...
                        <a href="../resident/residenthome.php">
